...
import (
	...
	sms "github.com/liucy1983/tencentcloud-sdk-go/tencentcloud/sms/v20190711" //引入sms
)
...
func main() {
	...
	request := sms.NewPullSmsReplyStatusByPhoneNumberRequest()
	...
	request.SendDateTime = common.Uint64Ptr(1577248386)
	/* 下发手机号码，采用 e.164 标准，+[国家或地区码][手机号]
	 * 示例如：+8613711112222， 其中前面有一个+号 ，86为国家码，13711112222为手机号*/
	request.PhoneNumber = common.StringPtr("+8615291996532")

	// 通过client对象调用想要访问的接口，需要传入请求对象
	response, err := client.PullSmsReplyStatusByPhoneNumber(request)
	// 处理异常
